...
#include <memory>
#include "../Checkpoint_For_Worker_Server/accountmodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AccountModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AccountModel_t qt_meta_stringdata_AccountModel = {
    {
QT_MOC_LITERAL(0, 0, 12) // "AccountModel"
...
QT_INIT_METAOBJECT const QMetaObject AccountModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractTableModel::staticMetaObject>(),
    qt_meta_stringdata_AccountModel.data,
    qt_meta_data_AccountModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AccountModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AccountModel.stringdata0))
